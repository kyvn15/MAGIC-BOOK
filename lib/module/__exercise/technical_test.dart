...
class TechnicalTest {
  ...
  List list = [
    ...
    // Exercise 141
    () {
      // ? Instruksi 1: Buatlah variabel List<Map<String, dynamic>> input dengan nilai [{"ciy": "New York", "population": 8378394}, {"city": "Los Angeles", "population": 3990456}]
      // ? Instruksi 2: Buatlah variabel List<Map<String, dynamic>>? output;
      // ? Instruksi 3: Konversi input menjadi List<Map<String, dynamic>> dan tampung di dalam variabel output
      // >>> Tulis jawabanmu di bawah ini
      List<Map<String, dynamic>> input = [
    ...
    () {
      ...
      // ? Instruksi: Buatlah variabel bool? output;
      // ? Instruksi: Konversi input me njadi List<dynamic> dengan mengambil semua nilai dari map
      // >>> Tulis jawabanmu di bawah ini
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      String input = "apple,banana,cherry";
      Map<String, int>? output = {for (var fruit in input.split(',')) fruit: 1};
      // --- End of Answer ---
    ...
    () {
      ...
      Map<int, String>? output = {
        for (var number in input.split(',')) int.parse(number): "value"
      };
    ...
    () {
      ...
      List<int>? output = input.map((item) => item.values.first).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      String input = "1,2,3,4,5";
      List<int>? output =
          input.split(',').map((number) => int.parse(number)).toList();
    ...
    () {
      ...
      List<String> input = ["apple", "banana", "cherry"];
      Map<String, int>? output = {
        for (var fruit in input) fruit: fruit.length,
      };
      // --- End of Answer ---
    ...
    () {
      ...
      List<int> input = [1, 2, 3, 4, 5];
      Map<int, int>? output = {
        for (var number in input) number: number * number,
      };
      // --- End of Answer ---
    ...
    () {
      ...
      List<String>? output =
          input.map((item) => item["fruit"] as String).toList();
